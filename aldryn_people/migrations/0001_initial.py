    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=models.CASCADE, related_name='translations', editable=False, to='aldryn_people.Group', null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=models.SET_NULL, verbose_name='group', blank=True, to='aldryn_people.Group', null=True)),
                ('user', models.ForeignKey(on_delete=models.SET_NULL, null=True, blank=True, to=settings.AUTH_USER_MODEL, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(max_length=15, db_index=True)),
                ('master', models.ForeignKey(on_delete=models.CASCADE, related_name='translations', editable=False, to='aldryn_people.Person', null=True)),
            ],
            options={
                'abstract': False,
