    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fax', models.CharField(max_length=100, null=True, verbose_name='fax', blank=True)),
                ('email', models.EmailField(default='', max_length=75, verbose_name='email', blank=True)),
                ('facebook', models.EmailField(default='', max_length=75, verbose_name='email', blank=True)),
                ('twitter', models.EmailField(default='', max_length=75, verbose_name='email', blank=True)),
                ('linkedin', models.EmailField(default='', max_length=75, verbose_name='email', blank=True)),
                ('location', models.EmailField(default='', max_length=75, verbose_name='email', blank=True)),
                ('website', models.URLField(null=True, verbose_name='website', blank=True)),
